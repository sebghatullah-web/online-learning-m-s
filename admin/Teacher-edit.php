                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-header">
                            ...
                            <a href="Teacher.php" class="btn btn-danger btn-sm float-right">Back</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="modal-body">
                                        <?php
                                            if(isset($_GET['user_id']))
                                            {
                                                ...
                                                $query = "SELECT * FROM teacher WHERE id='$user_id' LIMIT 1";
                                                    ...
                                                    foreach($query_run as $row)
                                                    {
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="<?php echo $row['id'] ?>" class="form-control" name="shortname">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="eduDegree">Education Degree</label>
                                                                    <input type="text" value="<?php echo $row['eduDegree'] ?>"  class="form-control" name="eduDegree">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" name="updateTeacher" class="btn btn-info">Update</button>
                                                        </div>
