                ...
                <div class="modal-body">
                    <div class="row">
							<div class="col-ms-6">
								...
								<div class="form-group">
									<label for="Creation Date">Father Name</label>
									<input type="text" class="form-control" placeholder="Education Degree" name="faname">
								</div>
								<div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form action="code.php" method="post">
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" name="DeleteStudentbtn" class="btn btn-primary">Yes, Delete.!</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="#" data-toggle="modal" data-target="#AddUserModal" class="btn btn-primary btn-sm float-right">Add Student</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            foreach($query_run as $row)
                                            {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="Student-edit.php?user_id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">Edit</a>
